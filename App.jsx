...
//const AdmissionDetail = lazy(() => import('./components/Admission/AdmissionDetail').then(m => ({ default: m.AdmissionDetail })));
...
const routeConfig = [
  ...
  //{ path: '/admissions/:id', element: <AdmissionDetail />, roles: [] },
